...
- LNS replay pressure-case infrastructure is now available: the replay label corpus includes generated corridor, gate, footprint-pressure, service-pressure, and anchor-service families; replay labels carry pressure-family and exploration-window metadata; learned-label runs report readiness against the scale gates. The readiness gate itself remains open until a generated artifact meets usable, non-neutral, family-balanced development and holdout thresholds.
...
| LNS replay label coverage | needs-scale | 84 usable replay labels in the 2026-04-27 bundle; readiness reporting now enforces family, seed, usable, non-neutral, and neutral-ratio gates | Blocks LNS ranker training and online hooks until a new replay artifact passes the scale gates. |
| Generated pressure-case coverage | partial | [SOLVER_ROADMAP_DELIVERED.md](SOLVER_ROADMAP_DELIVERED.md), item 30; replay corpus now includes corridor, gate, footprint-pressure, service-pressure, and anchor-service families | Pressure families exist for label generation, but promotion decisions still require a split-protected artifact that passes readiness gates. |
...
| --- | --- | ---: | --- | --- |
| 1 | LNS replay label artifact scale-up | 4.0 | Use the pressure replay corpus and readiness report to generate a split-protected LNS replay artifact across corridor, gate, footprint-pressure, service-pressure, and anchor-service families. | Protected development and holdout splits reach the label-scale gates for usable, non-neutral, and family-balanced replay labels. |
