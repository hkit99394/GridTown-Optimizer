  ...
  for (const outcome of telemetry.outcomes) {
    ...
    builder.push({
      ...
      evidence: {
        ...
        smallWindowDpEligible: outcome.smallWindowDp?.eligible ?? null,
        smallWindowDpReason: outcome.smallWindowDp?.reason ?? null,
        smallWindowDpUsableWindowCells: outcome.smallWindowDp?.usableWindowCells ?? null,
        smallWindowDpServiceCandidateCount: outcome.smallWindowDp?.serviceCandidateCount ?? null,
        smallWindowDpResidentialCandidateCount: outcome.smallWindowDp?.residentialCandidateCount ?? null,
        smallWindowDpRoadMaskCount: outcome.smallWindowDp?.roadMaskCount ?? null,
        smallWindowDpServiceSubsetCount: outcome.smallWindowDp?.serviceSubsetCount ?? null,
        smallWindowDpResidentialStateCount: outcome.smallWindowDp?.residentialStateCount ?? null,
        smallWindowDpElapsedSeconds: outcome.smallWindowDp?.elapsedSeconds ?? null,
        smallWindowDpBestPopulation: outcome.smallWindowDp?.bestPopulation ?? null,
