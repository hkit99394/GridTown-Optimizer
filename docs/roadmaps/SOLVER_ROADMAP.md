...
- Investigate the offline-to-online gap before any feature flag: the final-lift labels and tuned ranker improve offline holdout, but protected online remains neutral with a 100% override rate. Next evidence should add richer final-state features or longer/chunked roll-forward budgets, then recalibrate thresholds so high-confidence overrides are rarer and tied to durable final-score lift.
