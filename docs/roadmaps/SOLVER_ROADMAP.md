...
| Hosted or multi-user execution becomes a product requirement                                     | [Durable worker architecture](../design/DURABLE_WORKER_ARCHITECTURE.md)                         | Status, cancellation, and snapshots survive process restarts and multi-instance routing.                                                                          |
| Exact bounds or incumbents remain blocked after CP-SAT tuning                                    | [External MILP/SCIP/Gurobi/cuOpt research adapter](../design/EXTERNAL_EXACT_BACKEND_ADAPTER.md) | Better bounds or incumbents on selected families under exact evaluator validation.                                                                                |
