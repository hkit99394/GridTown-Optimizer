...
10. **Post-baseline governance backlog:** active on branch `features/post-baseline-trigger-governance` in [POST_BASELINE_TRIGGER_GOVERNANCE_BACKLOG.md](POST_BASELINE_TRIGGER_GOVERNANCE_BACKLOG.md). This branch should focus on PR #10 review readiness, governance discoverability, trigger-scaffold examples, and checker edge coverage.
