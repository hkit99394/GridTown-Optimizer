...
| G5  | Done   | Artifact soft-warning operating rule     | Make the `1501/1600` soft warning actionable for reviewers.                           | [ARTIFACT_POLICY.md](../ARTIFACT_POLICY.md) states which workflows may proceed under soft warning and which require an externalization plan first.                                  |
| G6  | Done   | PR review response runbook               | Keep future review fixes scoped and easy to verify.                                   | [PR_REVIEW_RESPONSE_RUNBOOK.md](PR_REVIEW_RESPONSE_RUNBOOK.md) records how to triage PR comments into docs-only, governance-script, planner, solver, evidence, or artifact buckets. |
