...
- Improve protected online signal before any feature flag: add roll-forward/final-score lift labels or an equivalent final-outcome payload so training can separate durable improvements from intermediate neutral repairs, then rerun protected holdout.
