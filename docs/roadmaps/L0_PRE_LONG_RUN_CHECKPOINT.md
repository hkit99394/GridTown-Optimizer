...
Status: Active as the pre-long-run handoff; current implemented fresh holdouts and evaluator-validity automation are sufficient for opt-in diagnostics, but no candidate is promotion-ready.
