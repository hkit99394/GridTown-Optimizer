...
1. **G6 PR review response runbook.** Prepare for review comments without mixing unrelated fixes.
2. **G7-G8 only on trigger.** Do not start solver implementation from this backlog unless the trigger ledger admits a current signal.
