...
| `fresh-multi-anchor-service-island` | Holdout     | `multi-anchor`, `service-pressure`, `gate` | Refresh pending             | L0 fresh product holdout for CP-SAT road semantics and service-island pressure. |
| `fresh-typed-footprint-scarcity`    | Holdout     | `footprint-pressure`, `service-pressure`   | Refresh pending             | L0 fresh product holdout for CP-SAT footprint scarcity and capacity pressure.   |
...
- The first product-workflow fresh holdout cases are now implemented for the CP-SAT intake; candidate-specific fresh-holdout evaluator validity is carried forward to L0/M9 before broad benchmarking.
